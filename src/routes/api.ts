...
apiRouter.get("/api/contacts/:contactId(\\d+)", ContactController.get) // regex to make sure contactId is number or digit
...
// Address API
apiRouter.post("/api/contacts/:contactId(\\d+)/addresses", AddressController.craete)
